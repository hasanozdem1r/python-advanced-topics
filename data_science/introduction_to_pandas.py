...
df_obj2=pd.DataFrame({'Bob': ['I liked it.', 'It was awful.'], 'Sue': ['Pretty good.', 'Bland.']})
print(df_obj2)

indexed_df=pd.DataFrame({'Bob': ['I liked it.', 'It was awful.'],
...
indexed_ser=pd.Series([30, 35, 40], index=['2015 Sales', '2016 Sales', '2017 Sales'], name='Product A')
print(indexed_ser)
